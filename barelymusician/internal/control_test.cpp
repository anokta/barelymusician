...
TEST(ControlTest, Set) {
  ...
  EXPECT_DOUBLE_EQ(control.GetSlopePerSecond(), 0.0);
  ...
  EXPECT_DOUBLE_EQ(control.GetValue(), 12.0);
  EXPECT_DOUBLE_EQ(control.GetSlopePerSecond(), 1.0);
...
TEST(ControlTest, Update) {
  ...
  EXPECT_DOUBLE_EQ(control.GetValue(), 16.0);
  EXPECT_DOUBLE_EQ(control.GetSlopePerSecond(), 2.0);
  ...
  EXPECT_DOUBLE_EQ(control.GetValue(), 20.0);
  EXPECT_DOUBLE_EQ(control.GetSlopePerSecond(), -5.0);
  ...
  EXPECT_DOUBLE_EQ(control.GetValue(), 12.0);
  EXPECT_DOUBLE_EQ(control.GetSlopePerSecond(), -10.0);
