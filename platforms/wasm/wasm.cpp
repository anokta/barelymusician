...
static void Engine_Process(Engine& engine, uintptr_t samples, int sample_count) noexcept {
  engine.Process(std::span<float>(reinterpret_cast<float*>(samples), sample_count));
}
