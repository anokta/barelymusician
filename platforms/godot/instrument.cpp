...
void BarelyInstrument::_bind_methods() {
  ...
  ADD_PROPERTY(
      PropertyInfo(Variant::FLOAT, "attack", PropertyHint::PROPERTY_HINT_RANGE, "0,1,0.01"),
      "set_attack", "get_attack");
  ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "decay", PropertyHint::PROPERTY_HINT_RANGE, "0,1,0.01"),
               "set_decay", "get_decay");
  ADD_PROPERTY(
      PropertyInfo(Variant::FLOAT, "sustain", PropertyHint::PROPERTY_HINT_RANGE, "0,1,0.01"),
      "set_sustain", "get_sustain");
  ADD_PROPERTY(
      PropertyInfo(Variant::FLOAT, "release", PropertyHint::PROPERTY_HINT_RANGE, "0,1,0.01"),
