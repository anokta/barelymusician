...
void LowPassEffect::Process(float* output_samples, int output_channel_count,
...
void LowPassEffect::SetControl(int index, Rational value, Rational /*slope_per_frame*/) noexcept {
